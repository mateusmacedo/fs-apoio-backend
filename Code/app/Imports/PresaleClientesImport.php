...
class PresaleClientesImport implements ToCollection, WithHeadingRow, WithChunkReading, WithCalculatedFormulas
{
    /**
     * @var LoggerInterface
     */
